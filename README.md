...
3. Commit your Changes with howmoji (`howmoji -c`) or  [gitmoji](https://gitmoji.dev/) `gitmoji -c`
...
1. Check the [existing issues](https://github.com/Felix-Blom/howmoji/issues) to make sure your emoji hasn't been suggested
2. Create a new issue with the following:
  - Title: `[Emoji Request] 🆕 Your emoji`
  - Description: How you use this emoji while coding
  - Example: When do you feel like using this emoji?

Remember: Focus on the "how" not the "what". Tell us about your coding state of mind! 😎
